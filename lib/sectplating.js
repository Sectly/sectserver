const { htmlEscape } = require(`./escapehtml`)

module.exports.MissingValueError = class MissingValueError extends Error {
  constructor(key) {
...
module.exports.sectplating = function(template, data, { ignoreMissing = false, transform = ({ value }) => value } = {}) {
